...
# Wordlist CLDF Dataset derived from Zhivlov's "Annotated Swadesh wordlists for the Ob-Ugrian group" from 2011
...
property | value
 --- | ---
[dc:bibliographicCitation](http://purl.org/dc/terms/bibliographicCitation) | Zhivlov, M. (2011): Annotated Swadesh wordlists for the Ob-Ugrian group (Uralic family). The Global Lexicostatistical Database. Moscow: RGGU.
...
[dcat:accessURL](http://www.w3.org/ns/dcat#accessURL) | https://github.com/SequenceComparison/zhivlovobugrian
[prov:wasDerivedFrom](http://www.w3.org/ns/prov#wasDerivedFrom) | <ol><li><a href="https://github.com/SequenceComparison/zhivlovobugrian/tree/0ed2296">SequenceComparison/zhivlovobugrian v1.0.1-1-g0ed2296</a></li><li><a href="https://github.com/glottolog/glottolog/tree/v5.0">Glottolog v5.0</a></li><li><a href="https://github.com/concepticon/concepticon-data/tree/v3.2.0">Concepticon v3.2.0</a></li><li><a href="https://github.com/cldf-clts/clts/tree/v2.3.0">CLTS v2.3.0</a></li></ol>
...
[rdf:ID](http://www.w3.org/1999/02/22-rdf-syntax-ns#ID) | zhivlovobugrian
...
[dc:extent](http://purl.org/dc/terms/extent) | 2055
